<?php /*a:3:{s:84:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/navigate/carouseList.html";i:1618120768;s:75:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/index/index.html";i:1629028550;s:70:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/header.html";i:1618120768;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<table class="table  table-hover table-bordered text-center" style="margin: 30px;width: 95%;float: left;">
    <div>
        <caption class="btn-default"
            ...
            <a href="javascript:void (0)" style="color: white;float: right;text-decoration: none;margin-right: 4%" onclick="navigates.prototype.addCarouse(this)" data-url="<?php echo url('navigate/addCarouse'); ?>"
               >
    ...
    <tr add-btn="<?php echo htmlentities($value['carouse_id']); ?>">
        <td class="col-sm-1" style="vertical-align: middle !important;"><?php echo $value['carouse_id']?:'空如也也'; ?></td>
        <td class="col-sm-2" style="vertical-align: middle !important;">
            <?php if(empty($value['carouse_img']) || (($value['carouse_img'] instanceof \think\Collection || $value['carouse_img'] instanceof \think\Paginator ) && $value['carouse_img']->isEmpty())): ?>
            暂时没有设置
            <?php else: ?>
            <img src="<?php echo htmlentities($value['carouse_img']); ?>" alt="" style="width: 80px;height: 40px">
            <?php endif; ?>
        </td>
        <td class="col-sm-2 "  style="vertical-align: middle !important;" data-id="<?php echo htmlentities($value['carouse_id']); ?>"><span class="carouse_desc"><?php echo $value['carouse_desc']?:'空如也也'; ?></span></td>
        <td class="col-sm-2" style="vertical-align: middle !important;"><?php echo $value['carouse_sort']?:'空如也也'; ?></td>
        <td class="col-sm-1" style="vertical-align: middle !important;"><input type="checkbox" class="is_show_list" value="<?php echo htmlentities($value['is_show']); ?>" <?php if($value['is_show']==1): ?>
                                    checked <?php else: ?><?php endif; ?> data-id='<?php echo htmlentities($value['carouse_id']); ?>'
            data-url="<?php echo url('Navigate/upCarouse'); ?>">
        </td>
        <td class="col-sm-2" style="vertical-align: middle !important;"><?php echo $value['create_time']?:'空如也也'; ?></td>
    ...
    <span style="margin: auto 40%;"><?php echo $data; ?></span>
</div>
...
<script>
    ...
    $(document).on("click",".carouse_desc",function(){
        ...
        $(".click_ipt").blur(function(){
            ...
            $.post("<?php echo url('Navigate/upCarouseDesc'); ?>",{id:upId,content:upContent},function (data) {
