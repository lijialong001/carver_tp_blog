<?php /*a:3:{s:79:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/admin/adminList.html";i:1618120768;s:75:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/index/index.html";i:1629028550;s:70:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/header.html";i:1618120768;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="manager" class="mainBox layui-row"
     style="height:auto!important;height:550px;min-height:550px;/*background-image: url('/static/admin/pub/img/city.jpg');*/background-repeat: no-repeat;background-position: center center; background-size: cover;">
    <div>
        <span class=" well well-sm layui-col-md12" style="background:steelblue;">
            ...
            <a href="javascript:void (0)" onclick="user.prototype.addAdmin(this)"
               data-url="<?php echo url('admin/addAdmin'); ?>" style="color: white">
    ...
    <table class="table table-hover">
        ...
        <tr>
            <td colspan="8">空如也也</td>
        </tr>
        <?php else: foreach($data['data'] as $key => $value): ?>
        <tr>
            <td align="center" style="vertical-align: middle !important;"><?php echo htmlentities($value['admin_id']); ?></td>
            <td align="center" style="vertical-align: middle !important;"><b><?php echo htmlentities($value['admin_name']); ?></b></td>
            <td align="center" style="vertical-align: middle !important;"><?php if($value['role_name'] ==
                '超级管理员'): ?> <span style="color: red;font-weight: bolder"><?php echo htmlentities($value['role_name']); ?></span><?php else: ?><?php echo htmlentities($value['role_name']); ?><?php endif; ?>
            </td>
            <td align="center" style="vertical-align: middle !important;"><?php echo htmlentities($value['admin_email']); ?></td>
            <td align="center" style="vertical-align: middle !important;"><img src="<?php echo htmlentities($value['admin_image']); ?>" alt=""
                                                                               style="width: 30px;height: 30px;border-radius: 100%">
            </td>
            <td align="center" style="vertical-align: middle !important;"><?php echo htmlentities(date( "Y-m-d H:i:s",!is_numeric($value['create_time'])? strtotime($value['create_time']) : $value['create_time'])); ?>
            </td>
            <td align="center" style="vertical-align: middle !important;"><?php if(empty($value['last_login']) || (($value['last_login'] instanceof \think\Collection || $value['last_login'] instanceof \think\Paginator ) && $value['last_login']->isEmpty())): ?>暂时没有登录记录
                <?php else: ?><?php echo htmlentities(date( "Y-m-d H:i:s",!is_numeric($value['last_login'])? strtotime($value['last_login']) : $value['last_login'])); ?><?php endif; ?>
            </td>
            <td align="center" style="vertical-align: middle !important;">
                <a href="<?php echo url('admin/updateAdmin',['admin_id'=>$value['admin_id']]); ?>" style="width: 20px;"
                   auth-data="<?php echo htmlentities(app('request')->session('admin_name')); ?>"><span
                ...
                <a href="javascript:void (0)" onclick="user.prototype.delAdmin(this)"
                   data-url="<?php echo url('admin/delAdmin'); ?>" data-id="<?php echo htmlentities($value['admin_id']); ?>"><span
