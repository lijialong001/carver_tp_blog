<?php /*a:3:{s:78:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/admin/roleList.html";i:1618120768;s:75:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/index/index.html";i:1625732731;s:70:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/header.html";i:1618120768;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="manager" class="mainBox layui-row"
    ...
    <div>
        <span class="well well-sm layui-col-md12" style="background:steelblue;color: white">
            ...
            <h1 style="display: inline-block;font-size: 20px;font-family: 华文楷体;float: right;margin-right: 2%"><a
                    ...
                    data-url="<?php echo url('admin/addRole'); ?>" style="color: white;">
    ...
    <table class="table table-hover">
        ...
        <tr>
            <td align="center" style="vertical-align: middle !important;"><?php echo htmlentities($value['role_id'][0]); ?></td>
            <td align="center" style="vertical-align: middle !important;"><?php echo htmlentities($key); ?></td>
            <td align="center" style="vertical-align: middle !important;">
                <?php if(empty($value['auth_desc']) || (($value['auth_desc'] instanceof \think\Collection || $value['auth_desc'] instanceof \think\Paginator ) && $value['auth_desc']->isEmpty())): ?>
                <span style="color: red">该角色没有任何权限</span>
                <?php else: ?>
                <button class="btn-primary btn-sm">
                    <?php echo htmlentities($value['auth_desc']); ?>
                </button>
                <?php endif; ?>
            </td>
            <td align="center" style="vertical-align: middle !important;">
                <button type="button" class="layui-btn layui-btn-radius" style="border-radius: 30px"
                        role-id="<?php echo htmlentities($value['role_id'][0]); ?>" data-url="<?php echo url('admin/removeRoleAuth'); ?>" title="点击解除权限"
                        onclick="role.prototype.removeRoleAuth(this)">
                    是否解除权限
                </button>
            </td>
            <td align="center">
                <a href="<?php echo url('admin/upRole',['role_id'=>$value['role_id'][0]]); ?>">
                    <button type="button" class="btn btn-success">
                        编辑
                    </button>
                </a>
                <a href="javascript:void (0)" onclick="role.prototype.delUpRoleAuth(this)"
                   data-url="<?php echo url('admin/delUpRoleAuth'); ?>" role-id="<?php echo htmlentities($value['role_id'][0]); ?>">
