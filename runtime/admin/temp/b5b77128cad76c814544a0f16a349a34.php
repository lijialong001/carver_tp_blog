<?php /*a:3:{s:83:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/article/editArticle.html";i:1618120768;s:75:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/index/index.html";i:1629028550;s:70:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/header.html";i:1618120768;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="margin-bottom: 90px">
    <form action="" id="editArticle" style="margin-left: 20px">
        <input type="hidden" value="<?php echo htmlentities($data['article_id']); ?>" name="article_id">
        <div class="layui-form-item" style="padding-top: 30px">
            <label class="layui-form-label text-center bg-success" style="width: 100px">所属导航</label>
            <div class="layui-input-block" style="width: 160px;text-align: center">
                <select name="article_guide" lay-verify="required" id="article_guide">
                    <option value="0" selected>请选择导航</option>
                    <?php foreach($navigations as $k => $v): ?>
                    <option value="<?php echo htmlentities($v['nav_id']); ?>" <?php if($v['nav_id']== $data['article_guide']): ?>selected<?php else: ?><?php endif; ?>><?php echo htmlentities($v['nav_name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label text-center bg-success" style="width: 100px">文章标题</label>
            <div class="layui-input-block">
                <input type="text" name="article_title" lay-verify="title" autocomplete="off" placeholder="请输入标题"
                       class="layui-input" style="width: 500px" value="<?php echo htmlentities($data['article_title']); ?>" id="up_title">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label text-center bg-success" style="width: 100px">文章标签</label>
            <div style="margin-left: 111px"><input data-role='tags-input' value="<?php echo htmlentities($data['article_label']); ?>"
                                                   style="color: red;" name="article_label"></div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label text-center bg-success" style="width: 100px">文章简介</label>
            <div class="layui-input-block" style="width: 500px;height: 109px">
            <textarea name="article_desc" id="up_desc" cols="30" rows="10"
                      style="border: 1px darkgrey solid;width: 398px;height: 98px;resize: none"><?php echo htmlentities($data['article_desc']); ?></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label text-center bg-success" style="width: 100px">是否显示</label>
            <input type="checkbox" name="is_show" value="<?php echo htmlentities($data['is_show']); ?>" <?php if($data['is_show']==1): ?> checked <?php else: ?><?php endif; ?>>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label text-center bg-success" style="width: 100px">点击量</label>
            <div class="layui-input-block">
                <input type="text" name="click_num" lay-verify="title" autocomplete="off" placeholder=""
                       class="layui-input" style="width: 60px;display: inline" value="<?php echo htmlentities($data['click_num']); ?>" maxlength="6"
                       id="up_click">
        ...
        <div class="layui-form-item">
            ...
            <input type="checkbox" name="is_top_show" value="<?php echo htmlentities($data['is_top_show']); ?>" <?php if($data['is_top_show']==1): ?> checked
                   <?php else: ?><?php endif; ?>>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label text-center bg-success" style="width: 100px">文章封面</label>
            <div class="layui-input-block">
                <img src="<?php echo htmlentities($data['article_img']); ?>" alt="" style="width: 50px;height: 40px" id="preview_img">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label text-center bg-success" style="width: 100px">文章内容</label>
            <div class="layui-input-block">
                <div class="m">
                    <div class="summernote" id="content"><?php echo $data['article_content']; ?></div>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button type="button" class="btn-primary btn-sm" id="sub_up_article">确认修改
                </button>
            </div>
        </div>
    </form>
