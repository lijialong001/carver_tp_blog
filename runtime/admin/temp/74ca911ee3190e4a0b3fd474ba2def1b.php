<?php /*a:3:{s:81:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/notice/noticeList.html";i:1618120768;s:75:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/index/index.html";i:1629028550;s:70:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/header.html";i:1618120768;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<table class="table  table-hover table-bordered text-center" style="margin: 30px;width: 95%">
    <caption class="btn-primary " style="padding-left: 30px;height: 50px;padding-top: 14px;font-size: 18px"><span
            class="glyphicon glyphicon-volume-up"></span>&nbsp;&nbsp;公告管理 / 公告列表
        <a href="javascript:void (0)" onclick="notice.prototype.addNotice(this)" data-url="<?php echo url('notice/addNotice'); ?>"
           style="color: white;float:right;margin-right: 4%;text-decoration: none"><span
    ...
    <tr>
        <td><?php echo $value['notice_content']?:'空如也也'; ?></td>
        <td><?php echo $value['add_user']?:'空如也也'; ?></td>
        <td><?php echo $value['createtime']?:'空如也也'; ?></td>
        <td>
            <a href="javascript:void (0)" data-url="<?php echo url('Notice/delNotice'); ?>"
               data-id="<?php echo htmlentities($value['notice_id']); ?>" onclick="notice.prototype.delNotice(this)">
                <span class="glyphicon glyphicon-remove-circle" style="color: rgb(255, 140, 60);font-size: 23px"><font
