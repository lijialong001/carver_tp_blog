<?php /*a:3:{s:77:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/log/actionLog.html";i:1618120768;s:75:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/index/index.html";i:1629028550;s:70:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/admin/view/header.html";i:1618120768;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<table class="table table-hover table-responsive table-bordered" style='margin:50px 20px auto 12px'>
    ...
    <tr>
        <td class="col-sm-1"><?php echo htmlentities($value['log_id']); ?></td>
        <td class="col-sm-1"><?php echo htmlentities($value['log_name']); ?></td>
        <td class="col-sm-1"><?php echo htmlentities($value['log_user']); ?></td>
        <td class="col-sm-1"><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($value['create_time'])? strtotime($value['create_time']) : $value['create_time'])); ?></td>
    </tr>
    <?php endforeach; ?>
    <?php endif; ?>
    </tbody>
</table>
<span style="float:right;margin-right: 20px"><?php echo $data; ?></span>
