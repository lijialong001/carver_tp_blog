<?php /*a:1:{s:82:"/www/wwwroot/101.200.121.249/carver_tp_blog/app/web/view/article/articleIndex.html";i:1628956606;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<article>
    ...
    <div class="lbox">
        ...
        <!--        <div class="headline">-->
        <!--            <ul>-->
        <!--                <li><a href="javascript:void (0)" title="小心情？"><img src="/static/admin/headdata/images/h1.jpg"-->
        <!--                                                                    alt="小心情"><span>小心情</span></a></li>-->
        <!--                <li><a href="javascript:void (0)" title="test"><img-->
        <!--                        src="/static/admin/headdata/images/h2.jpg" alt="test"><span>我的阅读</span></a>-->
        <!--                </li>-->
        <!--            </ul>-->
        <!--        </div>-->
        <!--headline end-->
        ...
        <div class="whitebg bloglist">
            ...
            <ul>
                <?php if(empty($articles['data']) || (($articles['data'] instanceof \think\Collection || $articles['data'] instanceof \think\Paginator ) && $articles['data']->isEmpty())): ?>
                快去发表文章吧!
                <?php else: foreach($articles['data'] as $key => $value): ?>
                <li>
                    <h3 class="blogtitle"><a
                            href="<?php echo url('ArticleUser/articleDetail'); ?>?article_id=<?php echo htmlentities($value['article_id']); ?>" style="font-weight: bolder"><?php echo htmlentities($value['article_title']); ?></a>
                    </h3>
...
" style="font-size: 16px; color: #1E9FFF;"></i>&nbsp;<?php echo htmlentities($value['article_label']); ?></span></span><span
                            class="glyphicon glyphicon-eye-open" style="margin-left: 30px"> <?php echo htmlentities($value['click_num']); ?></span>
                    </p>
                    <a href="<?php echo url('ArticleUser/articleDetail'); ?>?article_id=<?php echo htmlentities($value['article_id']); ?>" class="viewmore">阅读更多</a>
    ...
    <div class="rbox" style="font-family: 华文新魏">
        ...
        <div class="whitebg notice">
            ...
            <ul>
                ...
                <li style="background: lightsteelblue"><a href="javascript:void(0)" ><?php echo htmlentities($v['notice_content']); ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
